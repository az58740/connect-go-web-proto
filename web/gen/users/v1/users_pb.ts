...
proto3.util.setEnumType(UserStatus, "users.v1.UserStatus", [
...
proto3.util.setEnumType(UserType, "users.v1.UserType", [
...
export class Country extends Message<Country> {
  ...
  static readonly typeName = "users.v1.Country";
...
export class Province extends Message<Province> {
  ...
  /**
   * @generated from field: users.v1.Country country = 3;
   */
  country?: Country;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "users.v1.Province";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class City extends Message<City> {
  ...
  /**
   * @generated from field: users.v1.Province province = 3;
   */
  province?: Province;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "users.v1.City";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class Address extends Message<Address> {
  ...
  /**
   * @generated from field: users.v1.City city = 2;
   */
  city?: City;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "users.v1.Address";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class User extends Message<User> {
  ...
  /**
   * @generated from field: users.v1.Address address = 10;
   */
  address?: Address;

  /**
   * @generated from field: users.v1.UserStatus status = 11;
   */
  status = UserStatus.UNKNOWN;

  /**
   * @generated from field: users.v1.UserType type = 12;
   */
  type = UserType.USER;

  /**
   * @generated from field: repeated users.v1.Role roles = 13;
   */
  roles: Role[] = [];
...
export class Action extends Message<Action> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "users.v1.Action";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class Role extends Message<Role> {
  ...
  /**
   * @generated from field: repeated users.v1.Action actions = 3;
   */
  actions: Action[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "users.v1.Role";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class UserResponse extends Message<UserResponse> {
  ...
  /**
   * @generated from field: users.v1.Country usercountry = 2;
   */
  usercountry?: Country;

  /**
   * @generated from field: users.v1.Province userprovince = 3;
   */
  userprovince?: Province;

  /**
   * @generated from field: repeated users.v1.Action actions = 4;
   */
  actions: Action[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "users.v1.UserResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
